    ...
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 text-center">
        ...
        <div className="bg-surface border border-border rounded-2xl p-8 max-w-sm">
          ...
          <p className="text-gray-400 text-sm">This booking link is invalid or has expired.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-lg mx-auto px-4 py-8">
        ...
        {view === "cancelled" && (
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-400">Your appointment on {appt.date} at {appt.time_slot} has been cancelled.</p>
        ...
        {view === "detail" && (
          <div className="space-y-6">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm mt-1">Booking for {appt.client_name}</p>
            ...
            <div className="bg-surface border border-border rounded-2xl p-6 space-y-4">
              <p className="text-xs text-gray-500 uppercase tracking-wider font-medium">Appointment Details</p>
            ...
            {appt.shops && (
              <div className="bg-surface border border-border rounded-2xl p-4 space-y-2">
                <p className="text-xs text-gray-500 uppercase tracking-wider font-medium">Shop Info</p>
              ...
              <>
                {!showCancelConfirm ? (
                  ...
                  <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-4 space-y-3">
                    ...
                    <p className="text-xs text-gray-400">This cannot be undone. You&apos;ll need to rebook if you change your mind.</p>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <button onClick={() => { setView("detail"); setNewDate(null); setSlots([]); setNewTime(null); }}
                className="w-10 h-10 rounded-xl bg-surface border border-border flex items-center justify-center text-gray-400 hover:text-white transition-colors">
                <ArrowLeft size={18} />
              </button>
            ...
            <div className="bg-surface border border-border rounded-2xl p-4">
              <p className="text-xs text-gray-500 mb-3 uppercase tracking-wider font-medium">Current Appointment</p>
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isSelected ? "border-gold bg-gold/15 text-gold" : "border-border text-gray-400 hover:border-gold/30 hover:text-white"
                      )}
                    >
