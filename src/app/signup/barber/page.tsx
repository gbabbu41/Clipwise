    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Sign up and set up your shop through onboarding.</p>
        </div>
        ...
        {done ? (
          <div className="bg-surface border border-border rounded-2xl p-8 text-center space-y-4">
            ...
            <p className="text-sm text-gray-400">Your barber account is ready. Sign in to access your dashboard and complete your shop setup.</p>
                ...
                <div key={key} className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input type={type} value={form[key]} onChange={update(key)} placeholder={placeholder} required
                      className="w-full bg-surface-raised border border-border rounded-xl pl-9 pr-4 py-2.5 text-sm text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-gold/50 transition-all" />
                  </div>
                </div>
              ))}
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input type={showPass ? "text" : "password"} value={form.password} onChange={update("password")} placeholder="Min. 8 characters" required minLength={8}
                    className="w-full bg-surface-raised border border-border rounded-xl pl-9 pr-10 py-2.5 text-sm text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-gold/50 transition-all" />
