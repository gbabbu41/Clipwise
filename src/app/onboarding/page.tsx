      ...
      <div
        ...
        {step === 1 && (
          <div className="space-y-4 animate-fade-in">
            ...
            <p className="text-[#8f8f8f] text-sm">{planLimit === 1 ? "The free plan covers one chair — add yourself and you're ready. Upgrade anytime to add more chairs." : "Add yourself if you cut hair, and invite your team. You can always do this later from Staff."}</p>
