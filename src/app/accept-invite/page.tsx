            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input type={showPw ? "text" : "password"} value={password} onChange={e => setPassword(e.target.value)}
                  ...
                  className="w-full bg-surface-raised border border-border rounded-xl pl-9 pr-10 py-2.5 text-sm text-white placeholder:text-[#8f8f8f] focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold/50" />
                <button type="button" onClick={() => setShowPw(!showPw)} className="absolute right-3 top-1/2 -translate-y-1/2 text-[#8f8f8f] hover:text-white">
      ...
      <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 py-12">
        ...
        <div className="bg-surface border border-border rounded-2xl p-8 w-full max-w-md space-y-5">
          <div className="text-center">
            ...
            <p className="text-sm text-[#8f8f8f] mt-1">One last step before your barber dashboard.</p>
          </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input type={showPw ? "text" : "password"} value={confirmPw} onChange={e => setConfirmPw(e.target.value)}
                  ...
                  className="w-full bg-surface-raised border border-border rounded-xl pl-9 pr-4 py-2.5 text-sm text-white placeholder:text-[#8f8f8f] focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold/50" />
              </div>
            </div>
      ...
      <div className="bg-surface border border-border rounded-2xl p-8 w-full max-w-sm text-center">
        {status === "loading" && (
          <>
            ...
            <p className="text-sm text-[#8f8f8f] mt-1">Just a moment</p>
          </>
        )}
        {status === "linking" && (
          <>
            ...
            <p className="text-sm text-[#8f8f8f] mt-1">Linking you to your shop</p>
          </>
        )}
        {status === "done" && (
          <>
            ...
            <p className="text-sm text-[#8f8f8f] mt-1">Taking you to your barber dashboard…</p>
          </>
        )}
        {status === "error" && (
          <>
