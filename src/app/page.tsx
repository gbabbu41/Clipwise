...
export default function HomePage() {
  return <MarketingShell><HomePageStyles /><main id="public-main" className="home-content">
    ...
    {/* Trying a plum accent on just this button — every other PublicClose caller
        (product pages, why-clipwise, pricing) is untouched, and this page's own
        approved blue accent elsewhere (home-page-styles.tsx) is untouched too. */}
    <PublicClose ctaStyle={{ background: "#73608F", color: "#F4F1E8" }} />
  </main></MarketingShell>;
}
