    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-surface border-b border-border py-10">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 text-sm">Browse approved shops and send a join request directly to the owner.</p>
        </div>
      </div>
            ...
            {[
              ...
              <div key={key}>
                ...
                <input
                  ...
                  className="w-full bg-surface-raised border border-border rounded-xl px-3 py-2.5 text-sm text-white placeholder:text-gray-500 focus:outline-none focus:border-gold/50"
                />
              </div>
            ))}
            <div className="sm:col-span-2">
              <label className="text-xs text-gray-400 block mb-1.5">Short Bio (optional)</label>
              <textarea
                value={barberForm.bio}
                onChange={e => setBarberForm(f => ({ ...f, bio: e.target.value }))}
                rows={2}
                placeholder="Tell the shop owner about your experience..."
                className="w-full bg-surface-raised border border-border rounded-xl px-3 py-2.5 text-sm text-white placeholder:text-gray-500 focus:outline-none focus:border-gold/50 resize-none"
              />
            </div>
          </div>
        </div>
