          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={key}>
                ...
                <input
                  ...
                  className="w-full bg-surface-raised border border-border rounded-xl px-3 py-2.5 text-sm text-white placeholder:text-[#777] focus:outline-none focus:border-gold/50"
                />
              </div>
            ))}
            <div className="sm:col-span-2">
              ...
              <textarea
                ...
                className="w-full bg-surface-raised border border-border rounded-xl px-3 py-2.5 text-sm text-white placeholder:text-[#777] focus:outline-none focus:border-gold/50 resize-none"
              />
            </div>
          </div>
        </div>
                ...
                <div key={shop.id} className={cn("bg-surface border rounded-2xl p-5 transition-colors", requested ? "border-emerald-500/30" : "border-border hover:border-gold/30")}>
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <div className="flex items-center gap-1 text-[#777] text-xs mt-1">
                        <MapPin size={11} />
