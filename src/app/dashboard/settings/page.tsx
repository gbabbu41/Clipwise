...
const PLAN_INFO: PlanInfo[] = [
  ...
  },
  {
    ...
    features: ["Up to 9 barbers", "2 locations included — add more for $30/mo each (up to 5)", "Everything in Pro", "Full POS via Stripe Terminal (card reader sold separately)", "Inventory management", "Staff management", "Full analytics & reports", "Dedicated support"],
  },
];
