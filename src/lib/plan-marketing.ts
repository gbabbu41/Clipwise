...
export const PLAN_MARKETING: PlanMarketing[] = [
  { n: "Starter", plan: "starter", p: "Free", per: "forever", forWho: "For a single-chair shop starting out", pop: false, yes: ["1 chair", "Online booking page", "Appointment management", "Email confirmations & reminders"], no: ["SMS / text alerts", "Reviews & loyalty", "Marketing & analytics", "Walk-in & waitlist", "Customer payments", "POS system"], cta: "Get started free" },
  { n: "Pro", plan: "pro", p: "$23", per: "/mo", forWho: "For a growing shop — up to 4 chairs", pop: true, yes: ["21-day free trial — no card", "Up to 4 chairs", "Online booking + payments", "In-person POS (cash & card)", "SMS reminders & alerts", "Reviews, loyalty & marketing", "Walk-in & waitlist", "Tips, tax & analytics", "Stripe payouts"], no: ["Inventory"], cta: "Start free trial" },
  { n: "Premium", plan: "premium", p: "$79", per: "/mo", forWho: "For an established shop with a bigger team", pop: false, yes: ["21-day free trial — no card", "Up to 9 chairs", "Everything in Pro", "Full POS terminal (card reader sold separately)", "Inventory", "Staff & payroll", "2 locations — add more $30/mo each (up to 5)"], no: [], cta: "Start free trial" },
];
