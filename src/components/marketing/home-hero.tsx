...
/* Text-only wordmark, tiled evenly, full viewport width (breaks out of the
   ...
   sections below it. */
.mkt .home-hero::before{content:"";position:absolute;top:0;bottom:0;left:50%;width:100vw;transform:translateX(-50%);z-index:0;pointer-events:none;opacity:0;background-image:url(/new/logo-watermark-text.png);background-repeat:repeat;background-size:935px auto/* DISABLED: animation:hh-fade-in 2s ease-out forwards,hh-drift 90s linear infinite */}
...
.mkt .hh-copy h1 em{color:#dedee3;font-style:normal}
.mkt .hh-description{font-size:17px;line-height:1.7;color:#c5c5cd;max-width:45ch;margin:24px 0 28px}
