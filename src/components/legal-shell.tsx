    ...
    <div className="min-h-screen bg-background">
      <header className="border-b border-border">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <Link href="/" className="text-sm text-[#777] hover:text-white flex items-center gap-1.5">
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <p className="text-sm text-[#777] mt-1">Last updated: {updated}</p>
        ...
        <div className="mt-12 pt-6 border-t border-border flex flex-wrap gap-4 text-xs text-[#777]">
