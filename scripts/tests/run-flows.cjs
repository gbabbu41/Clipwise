...
execFileSync(process.execPath, [path.join(__dirname, 'reset-email-boundary-check.cjs')], { stdio: 'inherit' });
execFileSync(process.execPath, [path.join(__dirname, 'waitlist-availability-read-check.cjs')], { stdio: 'inherit' });
execFileSync(process.execPath, [path.join(__dirname, 'waitlist-booking-form-check.cjs')], { stdio: 'inherit' });
execFileSync(process.execPath, [path.join(__dirname, 'waitlist-resource-check.cjs')], { stdio: 'inherit' });
execFileSync(process.execPath, [path.join(__dirname, 'cancellation-email-check.cjs')], { stdio: 'inherit' });
execFileSync(process.execPath, [path.join(__dirname, 'waitlist-confirmation-email-check.cjs')], { stdio: 'inherit' });
execFileSync(process.execPath, [path.join(__dirname, 'birthday-email-check.cjs')], { stdio: 'inherit' });
...
execFileSync(process.execPath, [path.join(__dirname, 'client-profile-save-check.cjs')], { stdio: 'inherit' });
...
execFileSync(process.execPath, [path.join(__dirname, 'service-visibility-check.cjs')], { stdio: 'inherit' });
